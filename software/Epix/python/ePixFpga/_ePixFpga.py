...
class EpixM32Array(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add((
            ...
            ad.Ad9249ReadoutGroup(
                name='Ad9249Rdout[0].Adc[0]',
                offset=0x07000000,
                channels=8,
                enabled=False,
                expand=False),
            ad.Ad9249ReadoutGroup(
                name='Ad9249Rdout[0].Adc[1]',
                offset=0x08000000,
                channels=8,
                enabled=False,
                expand=False),
...
class EpixM32ArrayFpgaRegisters(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicR3ForceHigh',
                description='AsicR3ForceHigh',
                offset=0x0000013C,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicR2ForceHigh',
                description='AsicR2ForceHigh',
                offset=0x00000144,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicR1ForceHigh',
                description='AsicR1ForceHigh',
                offset=0x0000014C,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
        ...
        self.add((
            pr.RemoteVariable(
                name='AsicDigitalPwrEnable',
                description='AsicPower',
                offset=0x00000200,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
...
class EpixMsh(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add(
            pr.LocalCommand(
                name='InjDacRamp',
                description='[start, stop, step, points, dly]',
                value=[
                    0,
                    0,
                    0,
    ...
    def __init__(self, **kwargs):
        ...
        self.add(
            pr.LinkVariable(
                ...
                mode='RO',
                units='MHz',
                linkedGet=getFreqMHz,
                disp='{:1.6f}'))
        self.add(
            pr.RemoteVariable(
                name='CompOutThreshold',
                description='CompOutThreshold',
                offset=0x00000018,
                bitSize=14,
                bitOffset=0,
                base=pr.UInt,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicRstDly',
                description='AsicRstDly',
                offset=0x00000104,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicRstDlyUs',
                                 dependencies=[self.AsicRstDly],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicRstDly]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AsicRstWidth',
                description='AsicRstWidth',
                offset=0x00000108,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicRstWidthUs',
                                 dependencies=[self.AsicRstWidth],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicRstWidth]),
                                 disp='{:1.5f}'))

        self.add(
            pr.RemoteVariable(
                name='AsicCdsBlinePol',
                description='AsicCdsBlinePol',
                offset=0x0000010C,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicCdsBlineDly',
                description='AsicCdsBlineDly',
                offset=0x00000110,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicCdsBlineDlyUs',
                                 dependencies=[self.AsicCdsBlineDly],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicCdsBlineDly]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AsicCdsBlineWidth',
                description='AsicCdsBlineWidth',
                offset=0x00000114,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicCdsBlineWidthUs',
                                 dependencies=[self.AsicCdsBlineWidth],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicCdsBlineWidth]),
                                 disp='{:1.5f}'))

        self.add(
            pr.RemoteVariable(
                name='AsicRstCompPol',
                description='AsicRstCompPol',
                offset=0x00000118,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicRstCompDly',
                description='AsicRstCompDly',
                offset=0x0000011C,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicRstCompDlyUs',
                                 dependencies=[self.AsicRstCompDly],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicRstCompDly]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AsicRstCompWidth',
                description='AsicRstCompWidth',
                offset=0x00000120,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicRstCompWidthUs',
                                 dependencies=[self.AsicRstCompWidth],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicRstCompWidth]),
                                 disp='{:1.5f}'))

        self.add(
            pr.RemoteVariable(
                name='AsicSampleNPol',
                description='AsicSampleNPol',
                offset=0x00000124,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicSampleNDly',
                description='AsicSampleNDly',
                offset=0x00000128,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicSampleNDlyUs',
                                 dependencies=[self.AsicSampleNDly],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicSampleNDly]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AsicSampleNWidth',
                description='AsicSampleNWidth',
                offset=0x0000012C,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicSampleNWidthUs',
                                 dependencies=[self.AsicSampleNWidth],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicSampleNWidth]),
                                 disp='{:1.5f}'))

        self.add(
            pr.RemoteVariable(
                name='AsicGRPol',
                description='AsicGRPol',
                offset=0x00000130,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicGRDly',
                description='AsicGRDly',
                offset=0x00000134,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicGRDlyUs',
                                 dependencies=[self.AsicGRDly],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicGRDly]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AsicGRWidth',
                description='AsicGRWidth',
                offset=0x00000138,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicGRWidthUs',
                                 dependencies=[self.AsicGRWidth],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicGRWidth]),
                                 disp='{:1.5f}'))

        self.add(
            pr.RemoteVariable(
                name='AsicRdDly',
                description='AsicRdDly',
                offset=0x00000200,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicRdDlyUs',
                                 dependencies=[self.AsicRdDly],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicRdDly]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AsicRdHalfPer',
                description='AsicRdHalfPer',
                offset=0x00000204,
                bitSize=16,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicRdHalfPerUs',
                                 dependencies=[self.AsicRdHalfPer],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicRdHalfPer]),
                                 disp='{:1.5f}'))
        ...
        self.add(
            pr.RemoteVariable(
                ...
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='IRegDlyUs',
                                 dependencies=[self.IRegDly],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.IRegDly]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='IRegClkHalfPer',
                description='IRegClkHalfPer',
                offset=0x00000218,
                bitSize=16,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='IRegClkHalfPerUs',
                                 dependencies=[self.IRegClkHalfPer],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.IRegClkHalfPer]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='IRegDregLow',
                description='IRegDregLow',
                offset=0x0000021C,
                bitSize=32,
                bitOffset=0,
                base=pr.UInt,
...
class Cpix2(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add((
            ...
            ad.Ad9249ReadoutGroup(
                name='Ad9249Rdout[1].Adc[0]',
                offset=0x09000000,
                channels=4,
                enabled=False,
                expand=False),
            # ad.Ad9249ConfigGroup(name='Ad9249Config[0].Adc[0]', offset=0x0A000000),    # not used in tixel, disabled by microblaze
            # ad.Ad9249ConfigGroup(name='Ad9249Config[0].Adc[1]', offset=0x0A000800),
            # # not used in tixel, disabled by microblaze
...
class Cpix2FpgaRegisters(pr.Device):
    def __init__(self, **kwargs):
        ...
        # self.add(pr.RemoteVariable(name='IdCarrierHigh',
        # description='IdCarrierHigh',     offset=0x00000018, bitSize=32,
        # bitOffset=0, base=pr.UInt, disp = '{:#x}',  mode='RO'))
        self.add(
            pr.RemoteVariable(
                name='R0Polarity',
                description='R0Polarity',
                offset=0x00000410,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
        ...
        self.add(
            pr.RemoteVariable(
                name='EnAShiftPattern',
                description='EnAShiftPattern',
                offset=0x00000128,
                bitSize=32,
                bitOffset=0,
                base=pr.UInt,
        ...
        self.add(
            pr.RemoteVariable(
                name='EnBShiftPattern',
                description='EnBShiftPattern',
                offset=0x00000228,
                bitSize=32,
                bitOffset=0,
                base=pr.UInt,
        ...
        self.add(
            pr.RemoteVariable(
                name='triggerCntPerCycle',
                description='triggerCntPerCycle',
                offset=0x0000013C,
                bitSize=32,
                bitOffset=0,
                base=pr.UInt,
        ...
        self.add(
            pr.RemoteVariable(
                name='FastSyncPolarity',
                description='FastSyncPolarity',
                offset=0x0000015C,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
        ...
        self.add(
            pr.RemoteVariable(
                name='SerialReSyncPolarity',
                description='Serial resync polarity',
                offset=0x00000400,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
        ...
        self.add(
            pr.RemoteVariable(
                name='SerialReSyncDelay',
                description='Serial resync delay',
                offset=0x00000404,
                bitSize=32,
                bitOffset=0,
                base=pr.UInt,
        ...
        self.add(
            pr.RemoteVariable(
                name='SerialReSyncWidth',
                description='Serial resync width',
                offset=0x00000408,
                bitSize=32,
                bitOffset=0,
                base=pr.UInt,
        ...
        self.add(
            pr.RemoteVariable(
                name='SaciPrepRdoutCnt',
                description='SaciPrepRdoutCnt',
                offset=0x00000204,
                bitSize=32,
                bitOffset=0,
                base=pr.UInt,
        ...
        self.add(
            pr.RemoteVariable(
                name='VguardDacSetting',
                description='VguardDacSetting',
                offset=0x00000214,
                bitSize=16,
                bitOffset=0,
                base=pr.UInt,
...
# pr.RemoteVariable(name='AsicPwrManualFpga',  description='AsicPower',
# offset=0x0000020C, bitSize=1, bitOffset=23, base=pr.Bool, mode='RW')))
        self.add(
            pr.RemoteVariable(
                name='AsicMask',
                description='AsicMask',
        ...
        self.add(
            pr.RemoteVariable(
                name='VBias1DacSetting',
                description='VBias1DacSetting',
                offset=0x00000218,
                bitSize=16,
                bitOffset=0,
                base=pr.UInt,
        ...
        self.add(
            pr.RemoteVariable(
                name='VBias2DacSetting',
                description='VBias2DacSetting',
                offset=0x0000021C,
                bitSize=16,
                bitOffset=0,
                base=pr.UInt,
        ...
        self.add(
            pr.RemoteVariable(
                name='VBias3DacSetting',
                description='VBias3DacSetting',
                offset=0x00000220,
                bitSize=16,
                bitOffset=0,
                base=pr.UInt,
...
class EpixFpgaRegisters(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add(
            pr.RemoteVariable(
                name='RunTriggerEnable',
                description='Enable external run trigger',
                offset=0x00000001 *
                addrSize,
                bitSize=1,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='RunTriggerDelay',
                description='Run trigger delay',
                offset=0x00000002 *
                addrSize,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='RunTriggerDelayUs',
                                 dependencies=[self.RunTriggerDelay],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.RunTriggerDelay]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='DaqTriggerEnable',
                description='Enable external run trigger',
                offset=0x00000003 *
                addrSize,
                bitSize=1,
        ...
        self.add(
            pr.RemoteVariable(
                ...
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='DaqTriggerDelayUs',
                                 dependencies=[self.DaqTriggerDelay],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.DaqTriggerDelay]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AcqCount',
                description='Acquisition counter',
                offset=0x00000005 *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AcqCountReset',
                description='Reset acquisition counter',
                offset=0x00000006 *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='DacData',
                description='Sets analog DAC (MAX5443)',
                offset=0x00000007 *
                addrSize,
                bitSize=16,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='DigitalPowerEnable',
                description='Digital power enable',
                offset=0x00000008 *
                addrSize,
                bitSize=1,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AnalogPowerEnable',
                description='Analog power enable',
                offset=0x00000008 *
                addrSize,
                bitSize=1,
                bitOffset=1,
        ...
        self.add(
            pr.RemoteVariable(
                name='FpgaOutputEnable',
                description='Fpga output enable',
                offset=0x00000008 *
                addrSize,
                bitSize=1,
                bitOffset=2,
        ...
        self.add(
            pr.RemoteVariable(
                name='IDelayCtrlRdy',
                description='Ready flag for IDELAYCTRL block',
                offset=0x0000000A *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='SeqCount',
                description='Sequence (frame) Counter',
                offset=0x0000000B *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicMask',
                description='ASIC mask bits for the SACI access',
                offset=0x0000000D *
                addrSize,
                bitSize=4,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BaseClock',
                description='FPGA base clock frequency',
                offset=0x00000010 *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AutoRunEnable',
                description='Enable auto run trigger',
                offset=0x00000011 *
                addrSize,
                bitSize=1,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AutoRunPeriod',
                description='Auto run trigger period',
                offset=0x00000012 *
                addrSize,
                bitSize=32,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AutoRunPeriodMs',
                                 dependencies=[self.AutoRunPeriod],
                                 mode='RW',
                                 units='ms',
                                 linkedGet=getPerMs,
                                 linkedSet=setPerMs([self.AutoRunPeriod]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AutoDaqEnable',
                description='Enable auto DAQ trigger',
                offset=0x00000013 *
                addrSize,
                bitSize=1,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                ...
                description='Delay between system acq and ASIC reset pulse',
                offset=0x00000020 *
                addrSize,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AcqToAsicR0DelayUs',
                                 dependencies=[self.AcqToAsicR0Delay],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AcqToAsicR0Delay]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AsicR0ToAsicAcq',
                description='Delay between ASIC reset pulse and int. window',
                offset=0x00000021 *
                addrSize,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicR0ToAsicAcqUs',
                                 dependencies=[self.AsicR0ToAsicAcq],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicR0ToAsicAcq]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AsicAcqWidth',
                description='Width of ASIC acq signal',
                offset=0x00000022 *
                addrSize,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicAcqWidthUs',
                                 dependencies=[self.AsicAcqWidth],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicAcqWidth]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AsicAcqLToPPmatL',
                description='Delay bet. ASIC acq drop and power pulse drop',
                offset=0x00000023 *
                addrSize,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicAcqLToPPmatLUs',
                                 dependencies=[self.AsicAcqLToPPmatL],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicAcqLToPPmatL]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='AsicRoClkT',
                description='Width of readout clock ',
                offset=0x00000024 *
                addrSize,
                bitSize=16,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AdcClkHalfT',
                description='Width (in 8ns) of half clock period of ADC',
                offset=0x00000026 *
                addrSize,
                bitSize=31,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='TotalPixelsToRead',
                description='Total numbers of pixels to be readout',
                offset=0x00000027 *
                addrSize,
                bitSize=31,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicRoClk',
                description='ASIC RO Clock Signal',
                offset=0x00000029 *
                addrSize,
                bitSize=1,
                bitOffset=5,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicPinGRControl',
                description='Manual ASIC Global Reset Enabled',
                offset=0x0000002A *
                addrSize,
                bitSize=1,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicPinAcqControl',
                description='Manual ASIC Acq Enabled',
                offset=0x0000002A *
                addrSize,
                bitSize=1,
                bitOffset=1,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicPinROControl',
                description='Manual ASIC R0 Enabled',
                offset=0x0000002A *
                addrSize,
                bitSize=1,
                bitOffset=2,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicPinPpmatControl',
                description='Manual ASIC Ppmat Enabled',
                offset=0x0000002A *
                addrSize,
                bitSize=1,
                bitOffset=3,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicPinPpbeControl',
                description='Manual ASIC Ppbe Enabled',
                offset=0x0000002A *
                addrSize,
                bitSize=1,
                bitOffset=4,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicPinROClkControl',
                description='Manual ASIC RO Clock Enabled',
                offset=0x0000002A *
                addrSize,
                bitSize=1,
                bitOffset=5,
        ...
        self.add(
            pr.RemoteVariable(
                name='AdcPatternEnable',
                description='Enables test pattern on data out',
                offset=0x0000002A *
                addrSize,
                bitSize=1,
                bitOffset=8,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicR0Width',
                description='Width of R0 low pulse',
                offset=0x0000002B *
                addrSize,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicR0WidthUs',
                                 dependencies=[self.AsicR0Width],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicR0Width]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='DigitalCardId0',
                description='Digital Card Serial Number (low 32 bits)',
                offset=0x00000030 *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='DigitalCardId1',
                description='Digital Card Serial Number (high 32 bits)',
                offset=0x00000031 *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AnalogCardId0',
                description='Analog Card Serial Number (low 32 bits)',
                offset=0x00000032 *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AnalogCardId1',
                description='Analog Card Serial Number (high 32 bits)',
                offset=0x00000033 *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AsicPreAcqTime',
                description='Sum of time delays leading to the ASIC ACQ pulse',
                offset=0x00000039 *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                ...
                description='Delay between Ppmat pulse and readout',
                offset=0x0000003A *
                addrSize,
                bitSize=31,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='AsicPPmatToReadoutUs',
                                 dependencies=[self.AsicPPmatToReadout],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.AsicPPmatToReadout]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='CarrierCardId0',
                description='Carrier Card Serial Number (low 32 bits)',
                offset=0x0000003B *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='CarrierCardId1',
                description='Carrier Card Serial Number (high 32 bits)',
                offset=0x0000003C *
                addrSize,
                bitSize=32,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='PgpTrigEn',
                description='Set to enable triggering over PGP. Disables the TTL trigger input',
                offset=0x0000003D *
                addrSize,
                bitSize=1,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='RequestStartup',
                description='Request startup sequence',
                offset=0x00000080 *
                addrSize,
                bitSize=1,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='StartupDone',
                description='Startup sequence done',
                offset=0x00000080 *
                addrSize,
                bitSize=1,
                bitOffset=1,
        ...
        self.add(
            pr.RemoteVariable(
                name='StartupFail',
                description='Startup sequence failed',
                offset=0x00000080 *
                addrSize,
                bitSize=1,
                bitOffset=2,
        ...
        self.add(
            pr.RemoteVariable(
                name='AdcPipelineDelayA0',
                description='Number of samples to delay ADC reads of the ASIC0 chls',
                offset=0x00000090 *
                addrSize,
                bitSize=8,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AdcPipelineDelayA1',
                description='Number of samples to delay ADC reads of the ASIC1 chls',
                offset=0x00000091 *
                addrSize,
                bitSize=8,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AdcPipelineDelayA2',
                description='Number of samples to delay ADC reads of the ASIC2 chls',
                offset=0x00000092 *
                addrSize,
                bitSize=8,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='AdcPipelineDelayA3',
                description='Number of samples to delay ADC reads of the ASIC3 chls',
                offset=0x00000093 *
                addrSize,
                bitSize=8,
                bitOffset=0,
        ...
        self.add(pr.Command(name='testCpsw', description='Test CPSW',
                 function=collections.OrderedDict({'masterResetVar': 1, 'usleep': 100, 'counter': 1})))
    ...
    def __init__(self, **kwargs):
        ...
        self.add(
            pr.RemoteVariable(
                ...
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='InjStartDlyUs',
                                 dependencies=[self.InjStartDly],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.InjStartDly]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='InjStopDly',
                description='InjStopDly',
                offset=0x00000202 *
                addrSize,
                bitSize=32,
                bitOffset=0,
                base=pr.UInt,
                mode='RW'))
        self.add(pr.LinkVariable(name='InjStopDlyUs',
                                 dependencies=[self.InjStopDly],
                                 mode='RW',
                                 units='us',
                                 linkedGet=getPerUs,
                                 linkedSet=setPerUs([self.InjStopDly]),
                                 disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='InjSkip',
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly00',
                description='BankDly00',
                offset=0x00000300 *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly01',
                description='BankDly01',
                offset=0x00000301 *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly02',
                description='BankDly02',
                offset=0x00000302 *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly03',
                description='BankDly03',
                offset=0x00000303 *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly04',
                description='BankDly04',
                offset=0x00000304 *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly05',
                description='BankDly05',
                offset=0x00000305 *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly06',
                description='BankDly06',
                offset=0x00000306 *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly07',
                description='BankDly07',
                offset=0x00000307 *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly08',
                description='BankDly08',
                offset=0x00000308 *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly09',
                description='BankDly09',
                offset=0x00000309 *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly10',
                description='BankDly10',
                offset=0x0000030a *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly11',
                description='BankDly11',
                offset=0x0000030b *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly12',
                description='BankDly12',
                offset=0x0000030c *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly13',
                description='BankDly13',
                offset=0x0000030d *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly14',
                description='BankDly14',
                offset=0x0000030e *
                addrSize,
                bitSize=7,
                bitOffset=0,
        ...
        self.add(
            pr.RemoteVariable(
                name='BankPipelineDly15',
                description='BankDly15',
                offset=0x0000030f *
                addrSize,
                bitSize=7,
                bitOffset=0,
    ...
    def __init__(self, BaseClock=0, **kwargs):
        ...
        self.add(
            pr.RemoteVariable(
                ...
                mode='RW'))
        if self.BaseClock != 0:
            self.add(pr.LinkVariable(name='AutoTrigPeriodMs',
                                     dependencies=[self.AutoTrigPeriod],
                                     mode='RW',
                                     units='ms',
                                     linkedGet=getPerMs,
                                     linkedSet=setPerMs([self.AutoTrigPeriod]),
                                     disp='{:1.5f}'))
        self.add(
            pr.RemoteVariable(
                name='PgpTrigEn',
                description='PgpTrigEn',
                offset=0x0000001C,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
    ...
    def __init__(self, HsDacEnum, **kwargs):
        ...
        self.add((
            ...
            pr.RemoteVariable(
                ...
                base=pr.Bool,
                mode='RW'),
            pr.RemoteVariable(name='externalUpdateEn', description='Generates waveform when true',
                              offset=0x00000000, bitSize=1, bitOffset=2, base=pr.Bool, mode='RW'),
            pr.RemoteVariable(
...
class MMCM7Registers(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add((
            pr.RemoteVariable(
                name='CLKOUT0PhaseMux',
                description='CLKOUT0Reg1',
                offset=0x0000008 * 4,
                bitSize=3,
                bitOffset=13,
                base=pr.UInt,
        ...
        self.add((
            pr.RemoteVariable(
                name='CLKOUT1PhaseMux',
                description='CLKOUT1Reg1',
                offset=0x000000A * 4,
                bitSize=3,
                bitOffset=13,
                base=pr.UInt,
        ...
        self.add((
            pr.RemoteVariable(
                name='CLKOUT2PhaseMux',
                description='CLKOUT2Reg1',
                offset=0x000000C * 4,
                bitSize=3,
                bitOffset=13,
                base=pr.UInt,
        ...
        self.add((
            pr.RemoteVariable(
                name='CLKOUT3PhaseMux',
                description='CLKOUT3Reg1',
                offset=0x000000E * 4,
                bitSize=3,
                bitOffset=13,
                base=pr.UInt,
        ...
        self.add((
            pr.RemoteVariable(
                name='CLKOUT4PhaseMux',
                description='CLKOUT4Reg1',
                offset=0x0000010 * 4,
                bitSize=3,
                bitOffset=13,
                base=pr.UInt,
        ...
        self.add((
            pr.RemoteVariable(
                name='CLKOUT5PhaseMux',
                description='CLKOUT5Reg1',
                offset=0x0000006 * 4,
                bitSize=3,
                bitOffset=13,
                base=pr.UInt,
        ...
        self.add((
            pr.RemoteVariable(
                name='CLKOUT6PhaseMux',
                description='CLKOUT6Reg1',
                offset=0x0000012 * 4,
                bitSize=3,
                bitOffset=13,
                base=pr.UInt,
...
class AsicDeserHrRegisters(pr.Device):
    def __init__(self, **kwargs):
        ...
        for i in range(0, 64):
            self.add(
                pr.RemoteVariable(
                    name='IserdeseOut' + str(i),
                    description='IserdeseOut' + str(i),
...
class TSWaveCtrlEpixHR(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add((
            pr.RemoteVariable(
                name='userReset',
                description='Triggers user reset',
                offset=0x00000000,
                bitSize=1,
                bitOffset=0,
                base=pr.Bool,
...
class AsicTSPktRegisters(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add(
            pr.RemoteVariable(
                name='TSMode',
                description='Matches TS ASIC mode',
                offset=0x00000028,
                bitSize=2,
                bitOffset=0,
                base=pr.UInt,
...
class WaveformMemoryDevice(pr.MemoryDevice):
    def __init__(self, **kwargs):
        ...
        self.add(
            pr.Command(
                name='SetWaveform',
                description='Set test waveform for high speed DAC',
                function=self.fnSetWaveform))
        self.add(
            pr.Command(
                name='GetWaveform',
                description='Get test waveform for high speed DAC',
                function=self.fnGetWaveform))
