...
// Constructor
Epix100pAsic::Epix100pAsic ( uint destination, uint baseAddress, uint index, Device *parent, uint addrSize ) : 
                     Device(destination,baseAddress,"epix100pAsic",index,parent) {

   // Description
   desc_    = "Epix100p ASIC Object.";
   ...
   addRegister(new Register("CmdPrepForRead", baseAddress_ + 0x00000000*addrSize, 1));
   ...
   addRegister(new Register("MonostPulser", baseAddress_ + 0x00001001*addrSize, 1));
   ...
   //                    : Bit 0 = Test
   //                    : Bit 1 = Test
   addRegister(new Register("PixelDummy", baseAddress_ + 0x00001002*addrSize, 1));
   ...
   //                    : Bit  13  = sab_test
   //                    : Bit  14  = hrtest
   addRegister(new Register("Config3", baseAddress_ + 0x00001003*addrSize, 1));
   ...
   //                    : Bits 7:4 = DM2[3:0]
   addRegister(new Register("Config4", baseAddress_ + 0x00001004*addrSize, 1));
   ...
   addRegister(new Register("PulserDac", baseAddress_ + 0x00001005*addrSize, 1));
   ...
   //                    : Bit  1   = DM2en
   //                    : Bit  4   = SLVDSbit
   addRegister(new Register("Config6", baseAddress_ + 0x00001006*addrSize, 1));
   ...
   addRegister(new Register("VRef", baseAddress_ + 0x00001007*addrSize, 1));
   ...
   addRegister(new Register("Config8", baseAddress_ + 0x00001008*addrSize, 1));
   ...
   //                    : Bit  7:4 = S2D_GR[3:0]
   addRegister(new Register("Config9", baseAddress_ + 0x00001009*addrSize, 1));
   ...
   //                    : Bit  6:4 = Monost[2:0]
   //                    : Bit  7   = fastpp_enable
   addRegister(new Register("Config10", baseAddress_ + 0x0000100A*addrSize, 1));
   ...
   addRegister(new Register("Config11", baseAddress_ + 0x0000100B*addrSize, 1));
   ...
   addRegister(new Register("Config12", baseAddress_ + 0x0000100C*addrSize, 1));
   ...
   addRegister(new Register("Config13", baseAddress_ + 0x0000100D*addrSize, 1));
   ...
   //                    : Bit  7:2 = TPS_DAC[5:0]
   addRegister(new Register("Config14", baseAddress_ + 0x0000100E*addrSize, 1));
   ...
   //                    : Bit  7:2 = S2D_DAC[5:0]
   addRegister(new Register("Config15", baseAddress_ + 0x0000100F*addrSize, 1));
   ...
   //                    : Bit  2   = delEXEC
   //                    : Bit  3   = delCCkreg
   addRegister(new Register("Config16", baseAddress_ + 0x00001010*addrSize, 1));
   ...
   addRegister(new Register("RowStartAddr", baseAddress_ + 0x00001011*addrSize, 1));
   ...
   addRegister(new Register("RowStopAddr", baseAddress_ + 0x00001012*addrSize, 1));
   ...
   addRegister(new Register("ColStartAddr", baseAddress_ + 0x00001013*addrSize, 1));
   ...
   addRegister(new Register("ColStopAddr", baseAddress_ + 0x00001014*addrSize, 1));
   ...
   addRegister(new Register("ChipId", baseAddress_ + 0x00001015*addrSize, 1));

   addVariable(new Variable("ChipId", Variable::Status));
   getVariable("ChipId")->setDescription("");

   // CMD = 6, Addr = 17 : Row counter[8:0]
   addRegister(new Register("RowCounter", baseAddress_ + 0x00006011*addrSize, 1));
   ...
   addRegister(new Register("ColCounter", baseAddress_ + 0x00006013*addrSize, 1));
   ...
   addRegister(new Register("WriteRowData", baseAddress_ + 0x00002000*addrSize, 1));
   ...
   addRegister(new Register("WriteColData", baseAddress_ + 0x00003000*addrSize, 1));

   // CMD = 4, Addr = X  : Write Matrix with data
   addRegister(new Register("WriteMatrixData", baseAddress_ + 0x00004000*addrSize, 1));
   ...
   addRegister(new Register("WritePixelData", baseAddress_ + 0x00005000*addrSize, 1));
   ...
   addRegister(new Register("PrepareWriteChipIdA", baseAddress_ + 0x00007000*addrSize, 1));
   addRegister(new Register("PrepareWriteChipIdB", baseAddress_ + 0x00007015*addrSize, 1));

   // CMD = 8, Addr = X  : Prepare for row/column/matrix configuration
   addRegister(new Register("PrepareMultiConfig", baseAddress_ + 0x00008000*addrSize, 1));
...
// Deconstructor
Epix100pAsic::~Epix100pAsic ( ) { }

// Method to process a command
void Epix100pAsic::command ( string name, string arg) {
   stringstream tmp;
...
void Epix100pAsic::writeConfig ( bool force ) {
...
void Epix100pAsic::verifyConfig ( ) {
