...
// 06/07/2013: created
//-----------------------------------------------------------------------------
#ifndef __DIG_FPGA_TIXEL_H__
#define __DIG_FPGA_TIXEL_H__
...
class DigFpgaTixel : public Device {
   ...
   public:
      ...
      */
      DigFpgaTixel ( uint destination, uint baseAddress, uint index, Device *parent, uint addrSize );
