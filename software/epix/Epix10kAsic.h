...
// 06/06/2013: created
//-----------------------------------------------------------------------------
#ifndef __EPIX10K_ASIC_H__
#define __EPIX10K_ASIC_H__

#include <Device.h>
using namespace std;

//! Class to contain Kpix ASIC
class Epix10kAsic : public Device {
   ...
   public:
      ...
      */
      Epix10kAsic ( uint destination, uint baseAddress, uint index, Device *parent );
