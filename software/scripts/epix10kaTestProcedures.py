   ...
   if os.path.isdir(args.dir):
      ...
      for trbit in range(2):
         ...
         if trbit == 1:
            ...
            ePixBoard.Epix10ka.Epix10kaAsic[2].trbit.set(True)
            ePixBoard.Epix10ka.Epix10kaAsic[3].trbit.set(True)
         else:
         ...
         for x in range(8):
            for y in range(8):
               ...
               ePixBoard.Epix10ka.Epix10kaAsic[0].ClearMatrix()
               ePixBoard.Epix10ka.Epix10kaAsic[1].ClearMatrix()
               ePixBoard.Epix10ka.Epix10kaAsic[2].ClearMatrix()
               ePixBoard.Epix10ka.Epix10kaAsic[3].ClearMatrix()
               print('Setting ASICs matrix to %d%d pattern'%(x,y))
               setAsicMatrixGrid88(x, y, 1, ePixBoard.Epix10ka.Epix10kaAsic[0])
               ...
               ePixBoard.Epix10ka.Epix10kaAsic[1].PulserR.set(True)
               ePixBoard.Epix10ka.Epix10kaAsic[1].PulserR.set(False)
               ePixBoard.Epix10ka.Epix10kaAsic[2].PulserR.set(True)
         ...
         ePixBoard.Epix10ka.Epix10kaAsic[0].WriteMatrixData(12)
         ePixBoard.Epix10ka.Epix10kaAsic[1].PrepareMultiConfig()
         ePixBoard.Epix10ka.Epix10kaAsic[1].WriteMatrixData(12)
         ePixBoard.Epix10ka.Epix10kaAsic[2].PrepareMultiConfig()
         ePixBoard.Epix10ka.Epix10kaAsic[2].WriteMatrixData(12)
         ePixBoard.Epix10ka.Epix10kaAsic[3].PrepareMultiConfig()
         ePixBoard.Epix10ka.Epix10kaAsic[3].WriteMatrixData(12)
         ...
         ePixBoard.Epix10ka.Epix10kaAsic[1].PrepareMultiConfig()
         ePixBoard.Epix10ka.Epix10kaAsic[1].WriteMatrixData(8)
         ePixBoard.Epix10ka.Epix10kaAsic[2].PrepareMultiConfig()
         ePixBoard.Epix10ka.Epix10kaAsic[2].WriteMatrixData(8)
         ePixBoard.Epix10ka.Epix10kaAsic[3].PrepareMultiConfig()
         ePixBoard.Epix10ka.Epix10kaAsic[3].WriteMatrixData(8)
         ...
         ePixBoard.Epix10ka.Epix10kaAsic[3].trbit.set(True)
         ePixBoard.Epix10ka.Epix10kaAsic[0].PrepareMultiConfig()
         ePixBoard.Epix10ka.Epix10kaAsic[0].WriteMatrixData(0)
         ePixBoard.Epix10ka.Epix10kaAsic[1].PrepareMultiConfig()
         ePixBoard.Epix10ka.Epix10kaAsic[1].WriteMatrixData(0)
         ePixBoard.Epix10ka.Epix10kaAsic[2].PrepareMultiConfig()
         ePixBoard.Epix10ka.Epix10kaAsic[2].WriteMatrixData(0)
         ePixBoard.Epix10ka.Epix10kaAsic[3].PrepareMultiConfig()
         ePixBoard.Epix10ka.Epix10kaAsic[3].WriteMatrixData(0)
