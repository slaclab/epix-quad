...
# Setup python path
setenv PYTHONPATH ${PWD}/python:${ZMQ_DIR}/python:${SURF_DIR}/python:${COULTER_DIR}/python:${ROGUE_DIR}/python
...
if ($?LD_LIBRARY_PATH) then
   setenv LD_LIBRARY_PATH ${ROGUE_DIR}:${PYDIR}/lib:${ZMQ_DIR}/lib:${EPICS_LIB}:${LD_LIBRARY_PATH}
else
