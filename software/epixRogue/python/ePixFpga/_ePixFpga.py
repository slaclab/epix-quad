...
class Epix10ka(pr.Device):
   def __init__(self, **kwargs):
      ...
      self.add((
            EpixFpgaRegisters(name="EpixFpgaRegisters", offset=0x00000000),
            ...
            surf.AxiVersion.create(offset=0x08000000),
...
class EpixFpgaRegisters(pr.Device):
   def __init__(self, **kwargs):
      ...
      self.add(pr.Variable(name='AsicMask',            description='ASIC mask bits for the SACI access',                      offset=0x0000000D*addrSize, bitSize=4,  bitOffset=0, base='hex',  mode='RW'))
      ...
      self.add(pr.Variable(name='SwArmBit',            description='Software arm bit',                                        offset=0x00000050*addrSize, bitSize=1,  bitOffset=0, base='bool', mode='RW'))
      self.add(pr.Variable(name='SwTrgBit',            description='Software trigger bit',                                    offset=0x00000051*addrSize, bitSize=1,  bitOffset=0, base='bool', mode='WO'))
      self.add(pr.Variable(name='TriggerADCEn',        description='Trigger ADC enable',                                      offset=0x00000052*addrSize, bitSize=1,  bitOffset=0, base='bool', mode='RW'))
      self.add(pr.Variable(name='TriggerADCTh',        description='Trigger ADC threshold',                                   offset=0x00000052*addrSize, bitSize=16, bitOffset=16,base='hex',  mode='RW'))
      self.add(pr.Variable(name='TriggerADCMode',      description='Trigger ADC mode',                                        offset=0x00000052*addrSize, bitSize=2,  bitOffset=5, base='hex',  mode='RW'))
      self.add(pr.Variable(name='TriggerADCChannel',   description='Trigger ADC channel',                                     offset=0x00000052*addrSize, bitSize=4,  bitOffset=2, base='hex',  mode='RW'))
      self.add(pr.Variable(name='TriggerADCEdge',      description='Trigger ADC edge',                                        offset=0x00000052*addrSize, bitSize=1,  bitOffset=1, base='bool', mode='RW'))
      self.add(pr.Variable(name='TriggerHoldOff',      description='Number of samples to wait after the trigger is armed',    offset=0x00000053*addrSize, bitSize=13, bitOffset=0, base='hex',  mode='RW'))
      self.add(pr.Variable(name='TriggerTraceSkip',    description='Number of samples to skip before recording starts',       offset=0x00000054*addrSize, bitSize=13, bitOffset=13,base='hex',  mode='RW'))
      self.add(pr.Variable(name='TriggerTraceLength',  description='Number of samples to record',                             offset=0x00000054*addrSize, bitSize=13, bitOffset=0, base='hex',  mode='RW'))
      self.add(pr.Variable(name='InputChannelB',       description='Select input channel B',                                  offset=0x00000055*addrSize, bitSize=5,  bitOffset=5, base='hex',  mode='RW'))
      self.add(pr.Variable(name='InputChannelA',       description='Select input channel A',                                  offset=0x00000055*addrSize, bitSize=5,  bitOffset=0, base='hex',  mode='RW'))
