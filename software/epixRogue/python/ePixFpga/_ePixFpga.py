...
class Cpix2FpgaRegisters(pr.Device):
   def __init__(self, **kwargs):
      ...
      self.add(pr.Variable(name='EnSingleFrame',     description='EnSingleFrame',     offset=0x00000140, bitSize=1,  bitOffset=1, base='bool', verify = False, mode='RW'))
...
class HrPrototype(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add((
            ...
            AsicDeserRegisters(               name='Asic0Deserializer',        offset=0x10000000, enabled=False, expand=False),
            AsicDeserRegisters(               name='Asic1Deserializer',        offset=0x11000000, enabled=False, expand=False),
