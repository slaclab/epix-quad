...
def create(name='DigFpga', offset=0, memBase=None, hidden=False, enabled=True):
    ...
    dev.add(pr.Variable(name='AdcStreamMode',       description='Enables manual test of ADC',                              offset=0x0000002A*addrSize, bitSize=1,  bitOffset=6, base='bool', mode='RW'))
    dev.add(pr.Variable(name='AdcPatternEnable',    description='Enables test pattern on data out',                        offset=0x0000002A*addrSize, bitSize=1,  bitOffset=7, base='bool', mode='RW'))
    dev.add(pr.Variable(name='ROMode',              description='0: time with R0 low minimized (ePix100p), 1: normal (ePix10k)',  offset=0x0000002A*addrSize, bitSize=1,  bitOffset=8, base='bool', mode='RW'))
