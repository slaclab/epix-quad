...
class Cpix2Asic(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add(pr.Variable(name='CompTH1_DAC',   description='Config01', offset=0x00001001*addrSize, bitSize=6,  bitOffset=0,  base='uint',  mode='RW'))
        ...
        self.add(pr.Variable(name='VrefLow',       description='Config07', offset=0x00001007*addrSize, bitSize=2,  bitOffset=6,  base='uint',  mode='RW'))
