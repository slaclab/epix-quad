...
class Epix100aAsic(pr.Device):
    def __init__(self, **kwargs):
        ...
        # description='PrepareWriteChipIdB', offset=0x00007015*addrSize,
        # bitSize=32, bitOffset=0, base=pr.UInt, mode='RO')))
...
class EpixSAsic(pr.Device):
    def __init__(self, **kwargs):
        ...
        self.add(
            (pr.RemoteVariable(
                name='PulserSync',
                description='Pulse on SYNC signal',
                offset=0x00001001 *
                addrSize,
                bitSize=1,
                bitOffset=7,
...
class TixelAsic(pr.Device):
    def __init__(self, **kwargs):
        ...
        # pr.RemoteVariable(name='PrepareWriteChipIdB',
        # description='PrepareWriteChipIdB', offset=0x00007015*addrSize,
        # bitSize=32, bitOffset=0, base=pr.UInt, mode='RW')))
    ...
    def __init__(self, **kwargs):
        ...
        self.add(
            pr.RemoteVariable(
                ...
                hidden=False,
                overlapEn=True))
        # self.add(pr.RemoteRemoteVariable(name='PLL_RO_filt1',
        # description='Config_020F',
        # offset=[0x00001002*addrSize,0x0000100F*addrSize], bitSize=[1,2],
        # bitOffset=[7,0],  base=pr.UInt, disp = '{}',  mode='RW', disp='{#x}',
        # hidden=True, overlapEn=True))
        self.add(
            pr.RemoteVariable(
                name='PLL_RO_filter2',
                description='Config0F',
...
# description='PrepareMultiConfig', offset=0x00008000*addrSize,
# bitSize=32, bitOffset=0, function=pr.Command.touchZero, hidden=False))
