...
def main(argv):
   ...
   pythonDaq.daqSetConfig("digFpga:epix100pAsic:TpsGr","13")
   pythonDaq.daqSetConfig("digFpga:epix100pAsic:TpsDac","63")
   ...
   pythonDaq.daqSetConfig("digFpga:epix100pAsic:TpsMux","13")
