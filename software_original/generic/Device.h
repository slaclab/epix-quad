...
class Device {
   ...
   protected:
      ...
      void regReadInt ( string nameReg, string nameVar, uint bit=0, uint mask=0xFFFFFFFF);
      void regReadInt ( string name, uint bit=0, uint mask=0xFFFFFFFF );
      void regReadIntDec ( string nameReg, string nameVar, uint bit=0, uint mask=0xFFFFFFFF);
      void regReadIntDec ( string name, uint bit=0, uint mask=0xFFFFFFFF );
      void regWrite ( string nameReg, string nameVar, bool force, uint bit=0, uint mask=0xFFFFFFFF);
      void regWrite ( string name, bool force, uint bit=0, uint mask=0xFFFFFFFF  );
