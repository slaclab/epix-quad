...
#define ADC_TEST_OFFSET    (0x10000000)
#define ADC0_RDO_OFFSET    (0x14000000)
#define ADC1_RDO_OFFSET    (0x18000000)
#define ADC2_RDO_OFFSET    (0x1C000000)
#define ADC0_CFG_OFFSET    (0x20000000)
#define ADC1_CFG_OFFSET    (0x20000800)
#define ADC2_CFG_OFFSET    (0x20001000)
...
#define ASIC0_CFG16_REG  (BUS_OFFSET+ASIC0_OFFSET+(0x1010<<2))
#define ASIC1_CFG16_REG  (BUS_OFFSET+ASIC1_OFFSET+(0x1010<<2))
#define ASIC2_CFG16_REG  (BUS_OFFSET+ASIC2_OFFSET+(0x1010<<2))
#define ASIC3_CFG16_REG  (BUS_OFFSET+ASIC3_OFFSET+(0x1010<<2))
...
#define EPIX_PWR_REG       (BUS_OFFSET+(0x00000008<<2))
#define EPIX_ASIC_MASK_REG (BUS_OFFSET+(0x0000000D<<2))
#define EPIX_ADCCLK_REG    (BUS_OFFSET+(0x00000026<<2))
#define EPIX_ADC_ALIGN_REG (BUS_OFFSET+(0x00000080<<2))

unsigned int cfg4Asic[] = {ASIC0_CFG4_REG, ASIC1_CFG4_REG, ASIC2_CFG4_REG, ASIC3_CFG4_REG};
unsigned int cfg16Asic[] = {ASIC0_CFG16_REG, ASIC1_CFG16_REG, ASIC2_CFG16_REG, ASIC3_CFG16_REG};
