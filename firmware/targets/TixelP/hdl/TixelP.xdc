...
set_property PACKAGE_PIN   P1 [get_ports {asic01DM2}]
set_property IOSTANDARD LVCMOS25 [get_ports {asic01DM2}]
set_property PULLUP true [get_ports {asic01DM2}]
set_property PACKAGE_PIN  Y16 [get_ports {snIoCarrier}]
...
set_property PACKAGE_PIN M5 [get_ports {asicStart}]
set_property PACKAGE_PIN P2 [get_ports {asicPPbe}]
...
#ADC board gen1 route asicDout[0] to the TX pins of the GTX of the FPGA board gen2
