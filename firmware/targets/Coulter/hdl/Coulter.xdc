...
create_clock -period 8.0 -name gtTxOutClk \
    [get_pins U_CoulterPgp_1/NO_SIM.FIXED_LATENCY_PGP.U_Pgp2bGtp7FixedLatWrapper_1/Pgp2bGtp7Fixedlat_Inst/Gtp7Core_1/gtpe2_i/TXOUTCLK]
...
#    [get_pins U_CoulterPgp_1/NO_SIM.VARIABLE_LATENCY_PGP.U_Pgp2bGtp7VarLatWrapper_1/ClockManager7_Inst/MmcmGen.U_Mmcm/CLKOUT0]
#    [get_pins U_CoulterPgp_1/NO_SIM.VARIABLE_LATENCY_PGP.U_Pgp2bGtp7VarLatWrapper_1/Pgp2bGtp7VarLat_Inst/MuliLane_Inst/GTP7_CORE_GEN[0].Gtp7Core_Inst/gtpe2_i/TXOUTCLK]
...
# Fixed Latency Recovered Clock
create_clock -period 8.0 -name gtRecClk \
...
set_property PACKAGE_PIN   U2 [get_ports {adcDoP[0][0]}]
set_property PACKAGE_PIN   V2 [get_ports {adcDoM[0][0]}]
set_property PACKAGE_PIN   W2 [get_ports {adcDoP[0][1]}]
set_property PACKAGE_PIN   Y2 [get_ports {adcDoM[0][1]}]
set_property PACKAGE_PIN   U3 [get_ports {adcDoP[0][2]}]
set_property PACKAGE_PIN   V3 [get_ports {adcDoM[0][2]}]
set_property PACKAGE_PIN  AB3 [get_ports {adcDoP[0][3]}]
set_property PACKAGE_PIN  AB2 [get_ports {adcDoM[0][3]}]
set_property PACKAGE_PIN  AA5 [get_ports {adcDoP[0][4]}]
set_property PACKAGE_PIN  AB5 [get_ports {adcDoM[0][4]}]
set_property PACKAGE_PIN   W6 [get_ports {adcDoP[0][5]}]
set_property PACKAGE_PIN   W5 [get_ports {adcDoM[0][5]}]
# set_property PACKAGE_PIN   R6 [get_ports {adcDoP[0][6]}]
# set_property PACKAGE_PIN   T6 [get_ports {adcDoM[0][6]}]
# set_property PACKAGE_PIN   V7 [get_ports {adcDoP[0][7]}]
# set_property PACKAGE_PIN   W7 [get_ports {adcDoM[0][7]}]
set_property PACKAGE_PIN   C2 [get_ports {adcDoP[1][0]}]
set_property PACKAGE_PIN   B2 [get_ports {adcDoM[1][0]}]
set_property PACKAGE_PIN   E2 [get_ports {adcDoP[1][1]}]
set_property PACKAGE_PIN   D2 [get_ports {adcDoM[1][1]}]
set_property PACKAGE_PIN   F3 [get_ports {adcDoP[1][2]}]
set_property PACKAGE_PIN   E3 [get_ports {adcDoM[1][2]}]
set_property PACKAGE_PIN   H2 [get_ports {adcDoP[1][3]}]
set_property PACKAGE_PIN   G2 [get_ports {adcDoM[1][3]}]
set_property PACKAGE_PIN   J5 [get_ports {adcDoP[1][4]}]
set_property PACKAGE_PIN   H5 [get_ports {adcDoM[1][4]}]
set_property PACKAGE_PIN   M1 [get_ports {adcDoP[1][5]}]
set_property PACKAGE_PIN   L1 [get_ports {adcDoM[1][5]}]
# set_property PACKAGE_PIN   K6 [get_ports {adcDoP[1][6]}]
# set_property PACKAGE_PIN   J6 [get_ports {adcDoM[1][6]}]
# set_property PACKAGE_PIN   N4 [get_ports {adcDoP[1][7]}]
# set_property PACKAGE_PIN   N3 [get_ports {adcDoM[1][7]}]
