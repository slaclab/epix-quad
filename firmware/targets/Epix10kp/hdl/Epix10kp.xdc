...
set_property PACKAGE_PIN   Y8 [get_ports {asicSaciSel[0]}]
set_property PACKAGE_PIN   Y7 [get_ports {asicSaciSel[1]}]
set_property PACKAGE_PIN   B1 [get_ports {asicSaciSel[2]}]
set_property PACKAGE_PIN   A1 [get_ports {asicSaciSel[3]}]
...
set_property PACKAGE_PIN   M6 [get_ports {asicDm1}]
...
set_property PACKAGE_PIN  AA8 [get_ports {asicSync}]
set_property PACKAGE_PIN AB17 [get_ports {asicAcq}]
set_property IOSTANDARD LVCMOS25 [get_ports {asicDm1}]
...
set_property PACKAGE_PIN   W1 [get_ports {asic01DoutP}]
set_property IOSTANDARD LVDS_25 [get_ports {asic01DoutP}]
set_property DIFF_TERM true [get_ports {asic01DoutP}]
set_property PACKAGE_PIN   G1 [get_ports {asic23DoutP}]
set_property IOSTANDARD LVDS_25 [get_ports {asic23DoutP}]
set_property DIFF_TERM true [get_ports {asic23DoutP}]

set_property PACKAGE_PIN   R3 [get_ports {asic01RoClkP}]
set_property IOSTANDARD LVDS_25 [get_ports {asic01RoClkP}]
set_property PACKAGE_PIN   E1 [get_ports {asic23RoClkP}]
set_property IOSTANDARD LVDS_25 [get_ports {asic23RoClkP}]
