...
set_property PACKAGE_PIN   M6 [get_ports {snIoCarrier}]
...
#set_property PACKAGE_PIN  B1 [get_ports {asicDoutP[2]}]
#set_property PACKAGE_PIN  M6 [get_ports {asicDoutP[3]}]
#set_property PACKAGE_PIN  U1 [get_ports {asicDoutM[0]}]
#set_property PACKAGE_PIN  Y7 [get_ports {asicDoutM[1]}]
#set_property PACKAGE_PIN  A1 [get_ports {asicDoutM[2]}]
#set_property PACKAGE_PIN  M5 [get_ports {asicDoutM[3]}]
