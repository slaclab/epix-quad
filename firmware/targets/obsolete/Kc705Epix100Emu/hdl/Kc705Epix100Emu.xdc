...
set_property PACKAGE_PIN W22  [get_ports {serialIdIo[0]}]
set_property PACKAGE_PIN W21  [get_ports {serialIdIo[1]}]
set_property PACKAGE_PIN V24  [get_ports {serialIdIo[2]}]
set_property PACKAGE_PIN U24  [get_ports {serialIdIo[3]}]
set_property PACKAGE_PIN V22  [get_ports {serialIdIo[4]}]
set_property PACKAGE_PIN V21  [get_ports {serialIdIo[5]}]
set_property PACKAGE_PIN U23  [get_ports {serialIdIo[6]}]
set_property PACKAGE_PIN W24  [get_ports {serialIdIo[7]}]
set_property PACKAGE_PIN W23  [get_ports {serialIdIo[8]}]
set_property PACKAGE_PIN V20  [get_ports {serialIdIo[9]}]
set_property IOSTANDARD LVCMOS25 [get_ports serialIdIo*]
...
set_property PACKAGE_PIN H2 [get_ports gtTxP[4]]
set_property PACKAGE_PIN H1 [get_ports gtTxN[4]]
set_property PACKAGE_PIN G4 [get_ports gtRxP[4]]
set_property PACKAGE_PIN G3 [get_ports gtRxN[4]]
