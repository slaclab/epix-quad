...
set_property PACKAGE_PIN  AB6 [get_ports {asicClk}]
set_property IOSTANDARD LVCMOS25 [get_ports {asicClk}]
set_property PACKAGE_PIN  AA8 [get_ports {asicR1}]
set_property IOSTANDARD LVCMOS25 [get_ports {asicR1}]
set_property PACKAGE_PIN AA13 [get_ports {asicR2}]
set_property IOSTANDARD LVCMOS25 [get_ports {asicR2}]
set_property PACKAGE_PIN   U6 [get_ports {asicR3}]
set_property IOSTANDARD LVCMOS25 [get_ports {asicR3}]
set_property PACKAGE_PIN AA16 [get_ports {vbufOe}]
set_property IOSTANDARD LVCMOS25 [get_ports {vbufOe}]

set_property PACKAGE_PIN   V5 [get_ports {snIoCarrier}]
