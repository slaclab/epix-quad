...
setup(
    ...
    packages = [
        ...
        'epixQuad.surf.protocols.coaxpress',
        'epixQuad.surf.protocols.htsp',
        'epixQuad.surf.protocols.sugoi',
        ...
        'epixQuad.surf.devices.amphenol',
        ...
        'epixQuad.ePixAsics',
        'epixQuad.ePixFpga',
        'epixQuad.axi-pcie-core',
    ],
    package_dir = {
        'epixQuad': 'firmware/python/epix_quad',
        'epixQuad.surf': 'firmware/submodules/surf/python/surf',
        'epixQuad.axi-pcie-core': 'firmware/submodules/axi-pcie-core/python/axipcie',
